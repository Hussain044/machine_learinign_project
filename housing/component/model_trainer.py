...
from housing.entity.model_factory import GridSearchedBestModel, MetricInfoArtifact, ModelFactory, evaluate_regression_model
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self):
        try:
            ...
            logging.info(
                "Splitting training input, testing imput and target features")
            ...
            logging.info(
                f"Initializing model factory class using model config file: {model_config_file_path}")
            ...
            logging.info("Extracting trained mode list.")
            grid_searched_best_model_list: List[GridSearchedBestModel] = model_factory.grid_searched_best_model_list

            model_list = [
                model.best_model for model in grid_searched_best_model_list]
            logging.info(
                f"Evaluating all trained models on training and testing dataset")
            ...
            model_trainer_artifact = ModelTrainerArtifact(is_trained=True, message="Model Training completed successfully",
                                                          trained_model_file_path=trained_model_file_path, train_accuracy=metric_info.train_accuracy,
                                                          test_accuracy=metric_info.test_accuracy, train_rmse=metric_info.train_rmse,
                                                          test_rmse=metric_info.test_rmse, model_accuracy=metric_info.model_accuracy)
